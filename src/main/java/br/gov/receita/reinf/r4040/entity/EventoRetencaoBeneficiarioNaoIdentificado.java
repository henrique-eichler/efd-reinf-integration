...
@Entity
@Table(name = "evento_retencao_benef_nao_ident", schema = "r4040")
public class EventoRetencaoBeneficiarioNaoIdentificado {
    ...
    public boolean equals(Object o) {
        ...
        EventoRetencaoBeneficiarioNaoIdentificado that = (EventoRetencaoBeneficiarioNaoIdentificado) o;
    ...
    public static class Builder {
        private final EventoRetencaoBeneficiarioNaoIdentificado instance = new EventoRetencaoBeneficiarioNaoIdentificado();
        ...
        public EventoRetencaoBeneficiarioNaoIdentificado build() {
            return instance;
        }
    }
}