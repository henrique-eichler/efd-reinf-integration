...
@Entity
@Table(name = "evento_retencao_pj", schema = "r4020")
public class EventoRetencaoPessoaJuridica {
    ...
    public boolean equals(Object o) {
        ...
        EventoRetencaoPessoaJuridica that = (EventoRetencaoPessoaJuridica) o;
    ...
    public static class Builder {
        private final EventoRetencaoPessoaJuridica instance = new EventoRetencaoPessoaJuridica();
        ...
        public EventoRetencaoPessoaJuridica build() {
            return instance;
        }
    }
}